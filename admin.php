                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
								...
								<li>
                                    <a href="manager.php" class="mm-active">
                                        <i class="metismenu-icon pe-7s-rocket"></i>
                                        Manager Dashboard
                                    </a>
                                </li>
                                ...
                                <li class="app-sidebar__heading">Home Page Edit</li>
                                <li>
                                    <a href="#">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="admin_add_attraction.php">
                                                <i class="metismenu-icon">
                                                </i>Add New Attraction
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="add_featured.php">
                                                <i class="metismenu-icon">
                                                </i>Add New Featured Items
                                            </a>
                                        </li>
                                        <li>
                                            <a href="show_featured.php">
                                                <i class="metismenu-icon">
                                                </i>Show Featured Itrems
                                            </a>
                                        </li>
                                        <li>
                                            <a href="manage_featured.php">
                                                <i class="metismenu-icon">
                                                </i>Modify
                                            </a>
                                        </li>
                                ...
                                <li class="app-sidebar__heading">Analysis</li>
                                <li>
...
<script>
    function updateOrderCount() {
        $.ajax({
            url: 'get_total_orders.php', // URL to the PHP file
            method: 'GET',
            success: function(response) {
                $('#orderCount').text(response); // Update the span with the response
            }
        });
    }

    // Automatically update the count every 2 seconds
    setInterval(updateOrderCount, 2000);

    // Update on page load as well
    updateOrderCount();
</script>
...
<script>
    function updateTotalAmount() {
        $.ajax({
            url: 'get_total_amount.php', // URL to the PHP file
            method: 'GET',
            success: function(response) {
                $('#totalAmount').text('₹ ' + response); // Update the span with the response
            }
        });
    }

    // Automatically update the amount every 2 seconds
